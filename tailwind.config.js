  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        platvinted: 'rgb(var(--platvinted) / <alpha-value>)',
        platlbc: 'rgb(var(--platlbc) / <alpha-value>)',
        platfb: 'rgb(var(--platfb) / <alpha-value>)',
        platebay: 'rgb(var(--platebay) / <alpha-value>)',
        platvc: 'rgb(var(--platvc) / <alpha-value>)',
